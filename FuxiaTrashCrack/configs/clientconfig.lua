...
--//Anti AdminStuff//--
MyricaC.AntiPlayerBlips = false -- Detects a user that activated Player Blips and is not allowed
...
MyricaC.BlacklistedWeaponDelete = false -- This will detect CLIENT SIDED weapons and automatically delete them
...
MyricaC.BlacklistedWeaponDeleteBan = false -- This will BAN players with a blacklisted weapon in their inventory
