...
MyricaS.GeneralDiscordWebhookLink = "" -- General logging system (Here you will find ALL logs) -- Required.

MyricaS.EntitiesDiscordWebhookLink = ""  -- Optional , Logging Entities only webhook
MyricaS.WeaponsDiscordWebhookLink = ""  -- Optional , Logging Weapons detection only webhook
MyricaS.BlacklistedEventsWebhookLink = "" -- Optional , Logging Blacklisted Events detection only webhook
MyricaS.ExplosionsDiscordWebhookLink = "" -- Optional , Logging Explosions only webhook
MyricaS.SeclyDiscordWebhookLink = "" -- Optional , Logging Secly only webhook (Modmenu Injections,Lua manipulation)
...
MyricaS.BanSystem = true -- This on false will disable the ChocoHax's Ban System
    MyricaS.KickMessage = "Noob." -- You can edit this UwU
