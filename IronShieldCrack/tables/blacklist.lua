BlacklistedVehicle = { -- Detect and remove vehicle below
	"CARGOPLANE",
	"COG552",
	"COGNOSCENTI2",
	"CUBAN800",
...
BlacklistedPeds = { -- Detect and remove ped below
	"a_m_y_mexthug_01",
	"a_c_husky",
	"a_c_cat_01",
	"a_c_boar",
...
BlacklistedObject = { -- Detect, remove object and ban who created them
	...
	"prop_air_bigradar_slod", "p_fib_rubble_s", "prop_money_bag_01", "p_cs_mp_jet_01_s", "prop_poly_bag_money", "prop_air_radar_01", "hei_prop_carrier_radar_1", 
	...
	"hw1_blimp_cpr_null2", "prop_lev_des_barage_02", "hei_prop_carrier_defense_01", "prop_juicestand", "S_M_M_MovAlien_01", "s_m_m_movalien_01", "s_m_m_movallien_01", "u_m_y_babyd", 
	"CS_Orleans", "a_f_y_topless_01", "a_c_boar", "a_c_chimp", "a_c_coyote", 
	...
	"prop_v_hook_s", "prop_dock_crane_02_hook", "prop_winch_hook_long", "a_c_sharkhammer", "a_c_sharktiger", 
	"a_c_stingray", "CS_Orleans", "prop_windmill_01", "prop_Ld_ferris_wheel", "p_tram_crash_s", "p_oil_slick_01", "p_ld_soc_ball_01", "p_cablecar_s", "prop_beach_fire", 
	...
	"stt_prop_stunt_track_uturn", "stt_prop_stunt_track_hill", "prop_vintage_pump", "sr_prop_spec_tube_xxs_01a"
}