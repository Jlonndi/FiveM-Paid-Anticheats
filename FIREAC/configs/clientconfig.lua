...
---# Anti Blip Player #---
FIREACC.AntiBlips = false

---# Anti Cheat Citizen #---
FIREACC.CitizenWait = 2500

---# Anti Key #---
FIREACC.AntiKey = false
FIREACC.AntiKeyKick = false
FIREACC.AntiKeyBan = false
FIREACC.BlacklistKeys = {
	{{121}, "Insert Key"},
	{{37, 44}, "Tab + Q Keys"},
	{{47, 21}, "Shift + G Keys"},
	{{117}, "Numpad 7 Key"},
...
---# Anti Player Protection #---
FIREACC.AntiCheat = true
FIREACC.PlayerProtection = true

---# Anti Spectate #---
FIREACC.AntiSpectate = true

---# Anti BlackListWeapon #---
FIREACC.AntiBlackListWeapon = false

---# Anti God Mode #---
FIREACC.AntiGodmode = true

---# Anti Teleport #---
FIREACC.AntiNoclip = true

---# Anti Speed Hack #---
FIREACC.AntiSpeedHack = true
FIREACC.MaxSpeed = 10

---# Anti Vehicle Spawner #---
FIREACC.VehicleSpwan = true

---# Anti Infinity Ammo #---
FIREACC.AntiInfinityAmmo = true

---# Anti Thermal Vision #---
FIREACC.ThermalVision = true

---# Anti Night Vision #---
FIREACC.AntiNightVision = true
    
---# Anti SuperJumb #---
FIREACC.AntiSuperJump = false
FIREACC.SuperJumpMaxLength = 30.0

---# Anti Black List Commands #---
FIREACC.AntiBlackListCommands = true

---# Anti Cheat Engine #---
FIREACC.AntiCheatEngine = true

---# Anti Resource Starter #---
FIREACC.AntiResourceStarter = false

---# Anti Resource Stopper #---
FIREACC.AntiResourceStopper = false

---# Anti Invisble #---
FIREACC.AntiInvisble = true

---# Anti Change Damage #---
FIREACC.AntiWeaponDamageChange = true
FIREACC.AntiWeaponsExplosive = true
FIREACC.WeaponDamages = {
