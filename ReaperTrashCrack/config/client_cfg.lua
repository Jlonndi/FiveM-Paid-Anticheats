...
----//Anticheat//----
Config.AntiCheat = true -- Turn Anticheat // <ON/OFF>


----//Anti GodMode//----
----<DO NOT USE ON VRP>----
Config.AntiGodmode = false -- Anti-GodMode < Unstable / Use at your own risk

----//Anti-Nuke//----
Config.AntiFirePlayer = true -- Protect player against fire < HIGHLY RECOMMENDED
Config.PlayerProtection = true -- Protect player's against explosions < HIGHLY RECOMMENDED

----//Anti-Troll//----
Config.AntiCarDetroy = true -- HIGHLY RECOMMENDED
Config.AntiPedAttack = false  -- Anti Object Spawner / Ped Spawner < Unstable / Use at your own risk (Works but there may be false bans)

----//Anti-Injections//----
Config.AntiBMCGLOBAL = false -- Prevent some lua executors < HIGHLY RECOMMENDED
Config.AntiCMD = true -- Prevent some lua executors < HIGHLY RECOMMENDED
Config.AntiInyection = true -- Detects Some Menu Injections V1 < HIGHLY RECOMMENDED
Config.AntiInyectionv2 = false -- Detects Some Menu Injections V2 < Unstable / Use at your own risk

----//Anti-CheatEngine//----
Config.AntiCheatEngine = true -- Anti-CheatEngine < HIGHLY RECOMMENDED

--//Anti-AdminStuff//--
Config.AntiBlips = true  -- Detects a user that activated Player Blips and is not allowed to do that < HIGHLY RECOMMENDED
Config.AntiSpectate = false -- Detects a user that is spectating someone else and is not allowed to do that < HIGHLY RECOMMENDED
Config.MiniMap = true -- Detects a user that activated Player Blips and is not allowed to do that < HIGHLY RECOMMENDED
...
----//ANTI RESTART TOOLS//----
----<DO NOT RESTART SCRIPTS IF YOU ENABLE THIS>----
Config.AntiResourceStopCheck = false -- This script will check if a player tries to STOP a script < Unstable / Use at your own risk
